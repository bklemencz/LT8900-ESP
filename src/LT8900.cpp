...
void LT8900::begin()
{
  ...
  //fedcba9876543210
  writeRegister(32, 0x4800);  //AAABBCCCDDEEFFFG  A preamble length, B, syncword length, c trailer length, d packet type
  ...
  //setSyncWord(0x03805a5a03800380);
    writeRegister(36, 0x050A);
    writeRegister(37, 0x0000);
    writeRegister(38, 0x0000);
    writeRegister(39, 0x55AA);
